...
const openPhone = document.querySelector(".phone__icon")
...
class UI {
			...
			<article class="detalle-grid">
				...
				<div class="detalles-content">
					...
					<div class="rating">
						...
						<p class="descripcion">
							<b>Descripcion: </b> <span>Cuentas unicas desde el mes hasta el año</span>
						</p>
						<p class="description">
							<span>En CountsTec ofrecemos cuentas de calidad, en donde a nuestros clientes por un bajo costo les ofrecemos cualquier cuenta streamming que guste llevamos mas de 3 años vendiendo estas cuentas..</span>
						</p>
	...
	clearCarrito(){
		...
		while(carritoCenter.children.length > 0){
			...
			alert("Para la compra favor de tomar captura de pantalla del pedido y mandarlo al número: 5510624938 para hacer el pago mandar transferencia al siguiente numero de cuenta: 4152 3138 8129 8744 que esta al nombre: Roberto Sarmiento Uribe y del banco: BBVA por ultimo tomar captura o foto de la tranferencia, deposito, si es transferencia poner en el concepto 'dt-'nombre de la plataforma'' y mandarlo aquí dando clic en aceptar")
			window.location.href = "https://wa.me/qr/PBKJGUURPD5OM1";
